...
import { Home, BookOpen, Headphones, Users, ShoppingBag } from 'lucide-react';
...
export const FloatingDock = () => {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-2 z-30 flex justify-center px-2">
      <nav
        className="pointer-events-auto flex w-full items-center justify-between gap-1 rounded-2xl border border-border/60 bg-card/85 px-2 py-1.5 shadow-elevated backdrop-blur-xl supports-[backdrop-filter]:bg-card/65"
        aria-label="Primary"
      >
